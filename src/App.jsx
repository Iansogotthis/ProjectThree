...
function App() {
  ...
  return (
    <>
    <PageHeader />
    <h1 style={{ color: 'Grey', fontSize: '30px', textAlign: 'center', fontFamily: 'Bookman Oldstyle', fontWeight: 'bold' }}>Welcome to Vibetime</h1>
    <h2 style={{ color: 'Grey', fontSize: '20px', textAlign: 'center', fontFamily: 'Bookman Oldstyle' }}>
